...
import com.procter.databinding.FragmentTermsAndConditionsBinding;
...
public class TermsAndConditionsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        toolbarBindingBinding.txtHeader.setText("Terms and Conditions");
    ...
    private void getTermsAndConditions() {
        customDialog.show();
        viewModel.getTermsAndConditionsData(type).observe(this, s -> {
            binding.wvTermsAndConditions.loadData(s, "text/html", "UTF-8");
